    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="max-w-md w-full bg-surface p-8 rounded-2xl border border-surfaceHighlight shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Welcome back! Sign in to analyze your code.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 bg-primary hover:bg-blue-600 text-white font-medium rounded-lg transition-colors disabled:opacity-50 flex justify-center items-center"
          >
